...
ഹായ് {}, എന്റെ പേര് {}! ഞാൻ [ഇദ്ദേഹം](tg://user?id={}) നോക്കി നടത്തുന്ന ഒരു അടിപൊളി അഡ്മിൻ ബോട്ടാണ് [⚡️](https://telegra.ph/file/281966e0daa4251dfa70a.jpg),

നിങ്ങൾക്കും എന്നെ നിങ്ങളുടെ ഗ്രൂപ്പിൽ ഉപയോഗിക്കാം 🥰

കൂടുതൽ കമാന്റുകളെപ്പറ്റി അറിയുവാൻ /help അമർത്തുക.

Mᴀɪɴᴛᴀɪɴᴇᴅ Bʏ [ᴰˢ᭄KUNJAVA࿐](https://t.me/DS_KUNJAVA)
...
Pls Share And Support [🙏](https://telegra.ph/file/8e645807624c0800beca8.jpg),
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🎉 Add me to your group 🎉", url="t.me/{}?startgroup=true".format(bot.username))],
                     [InlineKeyboardButton(text="👨‍💻 Mʏ Dᴇᴠᴇʟᴏᴘᴇʀ ", url="https://t.me/DS_KUNJAVA"), InlinekeyboardButton(text="Sᴏᴜʀᴄᴇ Cᴏᴅᴇ", url="https://telegra.ph/file/a37f19af38c4a0c2f1f74.jpg")],
                     [InlineKeyboardButton(text="🔰 ɢʀᴏᴜᴘ 🔰", url="https://t.me/movie_house2"), InlineKeyboardButton(text="🌟 ᴄʜᴀɴɴᴇʟ 🌟", url="https://t.me/ds_movies1")],
